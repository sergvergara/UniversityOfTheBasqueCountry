...
public class VentanaTrianguloCompleta extends JFrame implements Observer {
	...
	private JPanel getPnlTexto() {
		if (pnlTexto == null) {
			...
			pnlTexto.setBorder(new TitledBorder(null,
					"Datos del tri${symbol_escape}u00E1ngulo", TitledBorder.LEADING,
			...
			gbl_pnlTexto.columnWeights = new double[] { ${version}, ${version},
					Double.MIN_VALUE };
			gbl_pnlTexto.rowWeights = new double[] { 0.0, 0.0, ${version},
					Double.MIN_VALUE };
	...
	public void update(Observable o, Object arg) {
	    ...
	    getTxtHipotenusa().setText(String.format("%1${symbol_dollar}.2f",modelo.getHipotenusa()));
