...
class OpAmpElm extends CircuitElm {
    ...
    public OpAmpElm(int xx, int yy) {
        ...
        gain       = 100000;
        setSize(sim.smallGridCheckItem.getState()
                ? 1
                : 2);
    }
    ...
    void setPoints() {
        ...
        plusFont = new Font("SansSerif", 0, (opsize == 2)
                                            ? 14
                                            : 10);
    }
