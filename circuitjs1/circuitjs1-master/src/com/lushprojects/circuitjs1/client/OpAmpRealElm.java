...
public class OpAmpRealElm extends CompositeElm {
    ...
    private static String model741String =
        ...
        +    // Q1-5
            ...
            "ResistorElm 4 1\rResistorElm 4 14\rResistorElm 4 5\rResistorElm 4 16\rResistorElm 4 24\rResistorElm 4 23\rResistorElm 17 18\r" + "ResistorElm 22 21\rResistorElm 21 20\r";
    ...
    private static double[] model741resistances = {
        50, 25, 1e3, 50e3, 1e3, 5e3, 50e3, 50, 39e3, 7500, 4500
    };
    ...
    public String dump() {
        return super.dumpWithMask(0) + " " + slewRate + " " + getCapacitor().voltdiff + " " + currentLimit + " "
               + modelType;
    }
    ...
    CapacitorElm getCapacitor() {
        return ((CapacitorElm) compElmList.get((modelType == MODEL_741)
                                               ? 20
                                               : 4));
    }
    ...
    void getInfo(String arr[]) {
        String type = (modelType == MODEL_741)
                      ? "LM741"
                      : "LM324";
