...
class TransformerElm extends CircuitElm {
    ...
    void draw(Graphics g) {
        ...
        for (i = 0; i != 2; i++) {
            ...
            drawCoil(g, dsign * ((i == 1)
                                 ? -6 * polarity
                                 : 6), ptCoil[i], ptCoil[i + 2], volts[i], volts[i + 2]);
        }
        ...
        drawPosts(g);
        setBbox(ptEnds[0], ptEnds[(polarity == 1)
                                  ? 3
                                  : 1], 0);
    }
    ...
    void reset() {
        ...
        current[0] = current[1] = volts[0] = volts[1] = volts[2] = volts[3] = curcount[0] = curcount[1] =
